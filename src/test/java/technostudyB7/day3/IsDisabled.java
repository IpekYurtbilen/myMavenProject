...
//    <button autocomplete="off" type="button" onclick="swapInput()">Enable</button><p id="message">It's disabled!</p><div id="loading" style="display: none;">Wait for it... <img src="/img/ajax-loader.gif"></div><br><div id="loading" style="display: none;">Wait for it... <img src="/img/ajax-loader.gif"></div><br>
//  </form>
        ...
        System.out.println("After click on enable button: "+isInputFieldEnabled);
